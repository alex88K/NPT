      ...
      <section class="advantage">
         <div class="container">
            ...
            <ul class="row advantage-list">
               <li class="col-md-3 col-sm-3 col-xs-6 advantage-item">
            ...
            <div class="partners-slider">
               <ul class="owl-carousel owl-theme slider-wrap">
                  <li class="slider-item">
                     <a href="/" class="slider-link"><img src="images/partners/traft.jpg" alt="Traft"></a>
                  </li>
                  <li class="slider-item">
                     <a href="/" class="slider-link"><img src="images/partners/atom.jpg" alt="атомєнергопроект"></a>
                  </li>
                  <li class="slider-item">
                     <a href="/" class="slider-link"><img src="images/partners/most.jpg" alt="МосТрансАренда"></a>
                  </li>
                  <li class="slider-item">
                     <a href="/" class="slider-link"><img src="images/partners/cast.jpg" alt="ЦАСТ"></a>
                  </li>
                  <li class="slider-item">
                     <a href="/" class="slider-link"><img src="images/partners/traft.jpg" alt="Traft"></a>
                  </li>
